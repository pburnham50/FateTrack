...
def buildConnections(filename_t0,greedy,openingCost=2, nnDist=3, DivScoreThreshold=3):
...
def main():
    ...
    parser.add_argument('--greedy', type = bool, default=False, dest='greed',help = 'Run greedy algorithm.')
    ...
    parser.add_argument('--nearNeighborDist', type = int, default=3, dest='nnDist', help = 'How many cell distances?')
