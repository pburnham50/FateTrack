...
def generateLinks(filename_t0, filename_t1,timepoint,pathtoimage="./",nnDist = 10,costMax=35, mN_Int = 10, mN_Ecc=4, mN_Area=25, mN_Disp=1):
    ip0 = buildFeatureFrame(filename_t0,timepoint,pathtoimage =pathtoimage)
    ip1 = buildFeatureFrame(filename_t1,timepoint+1,pathtoimage =pathtoimage)
...
def DivisionCanditates(propMtx, filename_t0,filename_t1,timepoint,mS_Area = 10, mS_Ecc = 2, mS_Int = 2, mS_Disp = 1, MDAR_thresh = 0.75, SDis_thresh = 20.0,pathtoimage="./" ):
    ip0 = buildFeatureFrame(filename_t0,timepoint,pathtoimage=pathtoimage)
    ip1 = buildFeatureFrame(filename_t1,timepoint+1,pathtoimage=pathtoimage)
...
def TranslationTable(filename_t0, filename_t1, DivisionTable,timepoint,pathtoimage ="./"):
    #rename
    ip0 = buildFeatureFrame(filename_t0,timepoint,pathtoimage =pathtoimage)
...
def SolveMinCostTable(filename_t0, filename_t1, DivisionTable,timepoint, OpeningCost = 30, ClosingCost = 30,pathtoimage ="./"):
    #rename
    ip0 = buildFeatureFrame(filename_t0,timepoint,pathtoimage =pathtoimage)
    ip0 = ip0.rename(columns={"label" : "label_t0"})
    ip1 = buildFeatureFrame(filename_t1,timepoint+1,pathtoimage =pathtoimage)
